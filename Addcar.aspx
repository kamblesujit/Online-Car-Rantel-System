...
<body>
    ...
    <div>
        ...
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="Seaters"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="FuelType"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label10" runat="server" Text="FuelType"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="RatePerKM"></asp:Label>
                </td>
                <td>
