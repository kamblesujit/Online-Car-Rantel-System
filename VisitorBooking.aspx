<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisitorBooking.aspx.cs" Inherits="VisitorBooking" %>
...
<body>
    ...
    <div class="container">
        <div class="row">
         <div class="col"></div>
         <div class="col">
             <asp:Label ID="Label8" runat="server" Text="" Font-Size="Large"></asp:Label></div>
         <div class="col"></div>
        ...
        <div class="row text-right border-bottom">
            <div class="col"><p></p>
                ...
                <asp:Button ID="btnnxt" class="btn btn-primary"  runat="server" Text="Next" onclick="btnnxt_Click" 
                     />
                <p></p>
            </div>
        ...
        <div class="row">
            <div class="col"><p></p>
                <asp:Label ID="Label6" runat="server" Text="Driving License"></asp:Label>
            </div>
            <div class="col"><p></p>
        ...
        <div class="row">
            <div class="col"><p></p>
                <asp:Label ID="Label7" runat="server" Text=" Adhaar Card No"></asp:Label>
            </div>
            <div class="col"><p></p>
        ...
        <div class="row border-bottom ">
            <div class="col text-right"><p></p>
                <asp:Button ID="btncon" class="btn btn-primary" runat="server" Text="Confirm" onclick="btncon_Click" 
                    />
                <p></p>
            </div>
